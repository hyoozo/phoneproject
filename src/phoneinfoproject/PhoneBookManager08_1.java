...
public class PhoneBookManager08_1 implements InputMenu, Menu, Serializable {
    //7 단계 HashSet 필드와 생성자 구현
    private Iterator<PhoneInfo> itr;
    private HashSet<PhoneInfo> set = new HashSet<>();
    private static PhoneBookManager08_1 instance = null;

    public static PhoneBookManager08_1 getInstance() {  //싱글톤 패턴사용
        if (instance == null) {
            instance = new PhoneBookManager08_1();
        }
        return instance;
    }
    private PhoneBookManager08_1() {
